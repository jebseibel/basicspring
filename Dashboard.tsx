import { Salad, Apple, Sparkles, Scale } from 'lucide-react';
import { useQuery } from '@tanstack/react-query';
import { foodApi, nutritionApi, flavorApi } from '../services/api';
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">
                Create custom salad with nutrition
              </p>
            </div>
          </a>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <span className="absolute inset-0" aria-hidden="true" />
              <p className="text-sm font-medium text-gray-900">Nutrition Data</p>
              <p className="text-sm text-gray-500 truncate">
